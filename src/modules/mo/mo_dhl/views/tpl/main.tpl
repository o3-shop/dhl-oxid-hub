...
[{oxscript include=$oViewConf->getModuleUrl("o3_dhl", "out/src/js/mo_dhl.js") priority=9}]
[{oxscript include=$oViewConf->getModuleUrl("o3_dhl", "out/src/js/widgets/mo_dhl__deliveryAddress.js") priority=9}]
[{if $oViewConf->moHasAncestorTheme('azure')}]
    [{oxscript include="js/widgets/oxmodalpopup.js" priority=8}]
    [{oxscript include=$oViewConf->getModuleUrl("o3_dhl", "out/src/js/widgets/azure/mo_dhl.js") priority=9}]
    [{oxscript include=$oViewConf->getModuleUrl("o3_dhl", "out/src/js/widgets/azure/mo_dhl__validation.js") priority=10}]
[{elseif $oViewConf->moHasAncestorTheme('flow')}]
    [{oxscript include=$oViewConf->getModuleUrl("o3_dhl", "out/src/js/widgets/flow/mo_dhl.js") priority=9}]
[{elseif $oViewConf->moHasAncestorTheme('wave')}]
    [{oxscript include=$oViewConf->getModuleUrl("o3_dhl", "out/src/js/widgets/wave/mo_dhl.js") priority=9}]
[{/if}]
